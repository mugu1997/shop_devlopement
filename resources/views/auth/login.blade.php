            ...
            <div class="card mb-0">
              <div class="card-body">
                ...
                <form id="login_form">
                  ...
                  <div class="mb-4">
                    <label for="exampleInputPassword1" class="form-label">Password(6 charecter password)</label>
                  ...
                  <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <a class="text-primary fw-bold" href="{{ url('register') }}">Register ?</a>
                  </div>
                  <button type="button" class="btn btn-primary w-100 py-8 fs-4 mb-4" id="login">Sign In</button>
                </form>
              </div>
            </div>
          </div>
